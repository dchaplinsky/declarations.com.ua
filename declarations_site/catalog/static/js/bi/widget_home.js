...
d3.csv("/static/data/declarations.csv", function(error, persons) {
  ...
  var states = d3.nest()
    ...
    //.sortValues(function(a,b) { return (a.area < b.area) })
    .rollup(function(leaves) { 
              ...
              //income_max = a1[a1.length - 1] > income_max ? a1[a1.length - 1] : income_max;
...
console.log(k)
  ...
  tr.on('click', function (e){ window.location.href = "http://127.0.0.1:8000/BI/?year=''&income=''&region=" + e.key  });  
...
svg.append("circle")
 ...
 svg.append("line")
  ...
  //d3.select("tbody").selectAll("tr").sort(function(a, b) { return b.values[0].median - a.values[0].median; });
