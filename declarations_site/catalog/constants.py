...
NACP_DECLARATION_NEW_FORMAT_INDEX = 'nacp_declarations_new_format'
CATALOG_INDICES = (OLD_DECLARATION_INDEX, NACP_DECLARATION_INDEX, NACP_DECLARATION_NEW_FORMAT_INDEX)
