...
Дані отримано за сайту [declarations.com.ua](declarations.com.ua). Вони включають в себе інформацію з декларацій про доходи українських чиновників, переважно з Міністрерства юстиції та судової влади. Дані не є репрезентативними та можуть включати незначні помилки. Аналіз провів [Захаров Кирило](https://github.com/Amice13) ([Promedia Consulting](http://pro-media.com.ua)).
...
kable(p, digits=c(0,1), caption=id$bank_uah)
...
kable(p, digits=c(0,1), caption=id$f_bank_uah)
...
kable(p, digits=c(0,1), caption=id$bank_usd)
...
kable(p, digits=c(0,1), caption=id$f_bank_usd)
...
kable(p, digits=c(0,1), caption=id$bank_eur)
...
kable(p,digits=c(1,1,1,1,1,1,1))
